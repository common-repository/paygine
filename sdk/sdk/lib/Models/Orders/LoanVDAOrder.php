...
/**
 * Кредитный заказ с вендором Всегда.Да (VsegdaDa)
 */
class LoanVDAOrder extends Order implements SpecificOrder, CreditOrder
{
    ...
    {
        return ($orderDTO->getParameterValue('vda_application_id') || isset($orderDTO->vda_application_id));
    }
